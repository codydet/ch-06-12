        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
            ...
            if (!app._compiledTemplates.smartSelectItem) {
                app._compiledTemplates.smartSelectItem = t7.compile(app.params.smartSelectItemTemplate ||
                    '{{#if isLabel}}' +
                    '<li class="multiline item-divider">{{groupLabel}}</li>' +
                    '{{else}}' +
                    '<li{{#if className}} class="multiline {{className}}"{{/if}}>' +
                        '<label class="multiline label-{{inputType}} item-content">' +
                            ...
                            '{{#if material}}' +
                                ...
                                '</div>' +
                                '<div class="multiline item-inner">' +
                                    '<div class="multiline item-title{{#if color}} color-{{color}}{{/if}}">{{text}}</div>' +
                                '</div>' +
                                '<div class="multiline item-after">' +
